...
<body>
    ...
    <h3>
        <center>
            LAPORAN PEMBAYARAN BARANG TANGGAL <?= tgl_indo($call_tanggal) ?> TAHUN AJARAN <?= call_ta($this->session->userdata('idta')) ?>
        </center>
    </h3>
    <div class="row">
        <div class="col-sm-12">
                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; font-size: 18px;">Jumlah Barang</th>
                    ...
                    <tbody>
                        <?php foreach ($data as $row) : ?>
                            <tr>
                                ...
                                <td align="right"><?= number_format(floatval($row->harga), 0, ',', '.') ?></td>

                            </tr>
                        <?php endforeach; ?>
                        <tr>
                            <td></td>
                            <td colspan="3"> <b>Total Bosda</b></td>
                            <td align="right"><b><?= number_format(floatval($bosda), 0, ',', '.') ?></b></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td colspan="3"> <b>Total Bosnas</b></td>
                            <td align="right"><b><?= number_format(floatval($bosnas), 0, ',', '.') ?></b></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td colspan="3"> <b>Total Dana Bos</b></td>
