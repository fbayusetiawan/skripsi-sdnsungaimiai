...
<body>
    ...
    <h3>
        <center>
            LAPORAN PEMBAYARAN BIAYA JASA TANGGAL <?= tgl_indo($call_tanggal) ?> TAHUN AJARAN <?= call_ta($this->session->userdata('idta')) ?>
        </center>
    </h3>
    <div class="row">
        <div class="col-sm-12">
                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; font-size: 18px;">Nama Jasa</th>
                            <th style="text-align:center; font-size: 18px;">Dari Dana</th>
                            <th style="text-align:center; font-size: 18px;">Biaya</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <?php foreach ($data as $row) : ?>
                            <tr>
                                ...
                                <td align="right"><?= number_format(floatval($row->biaya), 0, ',', '.') ?></td>
