...
<body>
    ...
    <h3>
        <center>
            LAPORAN BIAYA KEGIATAN TANGGAL <?= tgl_indo($call_tanggal) ?> TAHUN AJARAN <?= call_ta($this->session->userdata('idta')) ?>
        </center>
    </h3>
    <div class="row">
        <div class="col-sm-12">
                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center; font-size: 18px;">Kegiatan</th>
