...
class PSekolah extends CI_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('psekolah_m', 'primaryModel');
    }
    public $titles = 'Pembayaran Pengelolaan Sekolah';
    public $vn = 'psekolah';
    ...
    function addAction()
    {
        ...
        redirect('pembayaran/' . $this->vn . '/detail');
    }
    ...
    function goDetail()
    {
        ...
        $array = array(
            'idPembayaran' => $this->uri->segment(4)
        );
