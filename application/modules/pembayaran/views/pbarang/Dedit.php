            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/d_editAction/' . $this->uri->segment(4)) ?>" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" value="<?= $row->namaBarang ?>" name="namaBarang" required class="form-control">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" value="<?= $row->jumlahBarang ?>" name="jumlahBarang" required class="form-control">
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" value="<?= $row->hargaSatuan ?>" name="hargaSatuan" required class="form-control uang">
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
