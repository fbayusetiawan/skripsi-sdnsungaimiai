        ...
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    ...
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Guru Pengampu <small id="info"></small></label>
                        <input type="text" class="form-control" value="<?= $row->nip ?>" name="nip" id="nip" onkeyup="cekUser()" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
