                                ...
                                <td>
                                    <center>
                                        <div class="btn-group mb-0">
                                            <a href="<?= base_url($linkin . '/cover/' . $row->nisn . '/' . $tahun) ?>" class="btn btn-success btn-sm" target="_blank" data-toggle="tooltip" title="Cover"><i class="uil uil-print"></i> Cover</a>
                                        </div>
                                        <div class="btn-group mb-0">
