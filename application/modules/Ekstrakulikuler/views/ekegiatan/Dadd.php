            ...
            <div class="card-body">
                <form action="<?= base_url($linkin . '/d_addAction') ?>" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <?= cmb_dinamis('idEks', 'ekstrakulikuler', 'namaEks', 'idEks') ?>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="namaKegiatan" required class="form-control">
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="lamaKegiatan" required class="form-control">
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="biaya" required class="form-control uang">
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
