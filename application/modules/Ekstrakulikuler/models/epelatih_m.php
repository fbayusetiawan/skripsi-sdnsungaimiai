...
class epelatih_m extends CI_Model
{

    public $namaTable = 'e_pelatih';
    public $pk = 'idPelatihEks';
    ...
    {
        $this->db->join('pelatih', 'pelatih.idPelatih = e_pelatih.idPelatih', 'left');
        $this->db->join('ekstrakulikuler', 'ekstrakulikuler.idEks = pelatih.idEks', 'left');
