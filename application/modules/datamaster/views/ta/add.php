            ...
            <div class="card-body">
                <form action="<?= base_url($linkin . '/addAction') ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="tahunAjaran" id="validationCustom01" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <?=
                            form_dropdown('status', array('1' => 'Aktif', '0' => 'Tidak Aktif'), '0', 'class="form-control"');
                        ?>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
