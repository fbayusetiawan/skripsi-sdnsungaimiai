            ...
            <div class="card-body">
                <form class="needs-validation" enctype="multipart/form-data" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= $row->tahunAjaran ?>" name="tahunAjaran" id="validationCustom01" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <?=
                            form_dropdown('status', array('1' => 'Aktif', '0' => 'Tidak Aktif'), $row->status, 'class="form-control"');
                        ?>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
