            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" autofocus name="judulBerita" value="<?= $row->judulBerita ?>" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="isiBerita" value="<?= $row->isiBerita ?>" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" autofocus name="kategori" value="<?= $row->kategori ?>" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
