            ...
            <div class="card-body">
                <form action="<?= base_url($linkin . '/addAction') ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="kodeKelas" id="validationCustom01" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="namaKelas" id="validationCustom01" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <?= cmb_dinamis('nip', 'guru', 'namaGuru', 'nip', '') ?>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
