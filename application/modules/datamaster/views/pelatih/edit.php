            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Nama Pelatih</label>
                        <input type="text" class="form-control" value="<?= $row->namaPelatih ?>" name="namaPelatih" id="validationCustom01" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Ekstrakurikuler</label>
                        <?= droplist_dinamais('idEks', 'ekstrakulikuler', 'idEks', 'namaEks', 'idEks', $row->idEks) ?>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
