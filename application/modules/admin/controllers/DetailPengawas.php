...
class DetailPengawas extends CI_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('detailpengawas_m', 'primaryModel');
    }
    public $titles = 'Anggota Pengawas Ulangan/Ujian';
    public $vn = 'detailPengawas';
